...
This program computes numerically regulator integrals
associated to the elements xi_1(a,b) in the group K_4
of the modular curve Y_1(N), using the method
explained in Section 6 of the paper

F. Brunault, On the K_4 group of modular curves, arXiv:2009.07614

Examples of use:

Section 7:

1) To check numerically Beilinson's conjecture on
L(E,3) for the elliptic curve E = 15a1, with
precision 40 digits:

checkBeilinson("15a1", 40)

2) To check numerically Beilinson's conjecture on
L(E,3) for all elliptic curves E of conductor <= 20,
with precision 25 digits:

checkBeilinson([1, 20], 25)

Section 8:

To check numerically the conjecture relating the
elements xi_1(a,b) and the Beilinson elements, for
levels 11 <= N <= 28 and precision 40 digits:
